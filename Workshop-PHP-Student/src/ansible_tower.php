...
<p>Acesse: <a href="https://<?php echo getenv("TOWER");?>" class="bare"><button type="button" class="btn btn-danger btn-xs" target="blank">https://<?php echo getenv("TOWER");?></button></a>
<br>
