...
<div class="sect1">
<h2 id="_let_s_rock_on_ansible_tower">Let&#8217;s Rock on Ansible Tower!!</h2>
<div class="sectionbody">
<div class="sect3">
<h4 id="_lab01_acessando_o_tower">LAB01 - Acessando o Tower</h4>
<div id="__asciidoctor-preview-2474__" class="paragraph">
<p>Acesse: <a href="https://<?php echo getenv("TOWER");?>" class="bare"><button type="button" class="btn btn-danger btn-xs" target="_blank">https://<?php echo getenv("TOWER");?></button></a>
<br>
