...
mysql_select_db("demo", $id);
	$qr = "select id_image, nome_imagem  from demo_images where imagem <> ''";
...
?>
				    ...
				    <img style="width: 100%; display: block;" src="mostra_foto.php?id_imagem=<?php echo $id_image;?>" alt="image" />
                            <div class="mask">
