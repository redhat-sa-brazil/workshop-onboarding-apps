...
?>
        ...
        <div class="right_col" role="main">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Controle do Workshop <small>Alunos</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="javascript:EnviaEmailTodos()">Enviar Email Final para Todos os Alunos</a>
                          </li>
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      Lista de todos os alunos e operações para cada um.
                    </p>
            ...
            $Db = new Db;
            $qr = "select t1.*, t2.area from student as t1, area as t2 where t1.id_area = t2.id_area";
            $rs = $Db->m_query($qr);
            while($x=$Db->m_fetch_array($rs)) {
                    ...
                    $email = $x['email'];
                    $empresa = $x['empresa'];
                    $id_student = $x['id_student'];
                    $dthr_registro = $x['dthr_registro'];
            ?>
            <tr>
                          <td><?php echo $nome;?></td>
                          <td><?php echo $area;?></td>
